...
class JobSeeker(UserMixin, db.Model):
    ...
    current_position = db.Column(db.String(150), nullable=False)
...
class AppliedJob(db.Model):
    ...
    def __init__(self, job_title, first_name, middle_name, last_name, email,
                 phone_number, cover_letter, resume, job_id, user_id):
